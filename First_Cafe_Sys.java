...
public class First_Cafe_Sys {
  ...
  private void initialize() {
    ...
    JLabel lblNewLabel_2 = new JLabel(" 40 Rs ");
    ...
    JLabel label_7 = new JLabel(" 80 Rs ");
    ...
    JLabel lblThumpsUp = new JLabel("PAKOLA");
    ...
    JLabel lblContactDetails = new JLabel("GROUP DETAILS:");
    ...
    JLabel group1 = new JLabel("ABIHA AFSAR");
    group1.setFont(new Font("Times New Roman", Font.PLAIN, 18));
    group1.setBounds(21, 68, 198, 31);
    panel_1.add(group1);

    JLabel group2 = new JLabel("ALEENA RAFI");
    group2.setFont(new Font("Times New Roman", Font.PLAIN, 18));
    group2.setBounds(21, 83, 198, 31);
    panel_1.add(group2);

    JLabel group3 = new JLabel("SHAMEEN FATIMA");
    group3.setFont(new Font("Times New Roman", Font.PLAIN, 18));
    group3.setBounds(21, 98, 198, 31);
    panel_1.add(group3);

    JLabel group4 = new JLabel("RUQAIYA KHAN");
    group4.setFont(new Font("Times New Roman", Font.PLAIN, 18));
    group4.setBounds(21, 113, 198, 31);
    panel_1.add(group4);

    JLabel lblMobNo = new JLabel("Jinnah University For Women");
    lblMobNo.setFont(new Font("Times New Roman", Font.BOLD, 11));
    lblMobNo.setBounds(21, 185, 170, 31);
    panel_1.add(lblMobNo);

    JLabel location = new JLabel("Karachi,Pakistan");
    location.setFont(new Font("Times New Roman", Font.PLAIN, 18));
    location.setBounds(21, 200, 198, 31);
    ...
    JLabel lblPestry = new JLabel("PASTRY");
    ...
    JLabel lblDonat = new JLabel("DONUT");
