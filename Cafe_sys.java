...
public class Cafe_sys {
  ...
  public void initialize1() {
    ...
    JLabel lblCafeManagementSystem = new JLabel("Sip n Savor");
    ...
    btnTotal.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        lblitmTot.setText(LastTotal + "Rs ");
        // ====================For Total Block 2========================
        ...
        lblDrk.setText(last_totDrk1 + "Rs ");
        // =====================CODE FOR RECEIPT ======================
        ...
        if (Qut > 0) {
          ...
          if (QutD1 > 0)
            textArea.append("\n            PASTRY :       " + QutD1 + "   Rs " + Ds1);
          if (QutD2 > 0)
            textArea.append("\n            ICE-CREAM :        " + QutD2 + "        Rs" + Ds2);
          if (QutD3 > 0)
            textArea.append("\n            DONUTS :          " + QutD3 + "      Rs " + Ds3);
          if (QutD4 > 0)
            textArea.append("\n            CUPCAKE :       " + QutD4 + "      Rs " + Ds4);
        ...
        if (Qutdrk > 0) {
          ...
          textArea.append("\n           TOTAL PRICE OF DRINK :  " + "  Rs " + last_totDrk1);

        }
        double FinalTotal = Totalone + Totaltwo + Totalthree;
        textArea.append("\n\n      TOTAL AMOUNT TO PAY:  Rs " + FinalTotal);
        data_saver.save(textArea);
      }
    });
